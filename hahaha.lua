...
menu.bg.Position     = UDim2.new(0.5,-menu.bg.Size.X.Offset/2,0.3,-menu.bg.Size.Y.Offset/2)
menu.Parent          = game:GetService("CoreGui")
menu.bg.pre.Text = 'Preshot<font color="#26ab23">.win</font>  —  <font color="#626c65">[alpha]</font>'
...
function library:refreshConfigs()
    local tbl = {}
    for i, v in next, listfiles("Preshot") do
        table.insert(tbl, v)
    end
